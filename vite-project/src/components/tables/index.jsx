...
// Function to generate different colors based on seats count
function getColor(seatsCount) {
  switch (seatsCount) {
    case 4:
      return '#FFD700'; // Gold color for 4 seats
    case 5:
      return '#00CED1'; // Dark Turquoise color for 5 seats
    case 10:
      return '#FF6347'; // Tomato color for 10 seats
    default:
      return '#808080'; // Gray color for other seat counts
  }
}
